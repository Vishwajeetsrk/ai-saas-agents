...
export const metadata: Metadata = {
  title: 'AI SaaS - Autonomous AI Agents',
  description: 'Seven autonomous AI agents to analyze projects, generate code, debug, optimize databases, and create documentation.',
  generator: 'v0.app',
  icons: {
    icon: [
      {
